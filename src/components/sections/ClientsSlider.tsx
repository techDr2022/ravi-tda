...
const DOCTORS: Doctor[] = [
  ...
  {
    id: 2,
    name: 'Dr. Anupama Swarna',
    specialty: 'Gastroenterologist',
    clinic: 'Jade Clinic',
    location: 'Hyderabad',
    image: '/doctors/Dr Anupama Swarna - Specialist in Gastroenterology, Hepatology & Therapeutic Endoscopy - Jade Clinic.jpg',
  ...
  },
  {
    ...
    location: 'Hyderabad',
    image: '/doctors/Dr Deepa Reddy  Radiologist.jpg',
  ...
  {
    id: 4,
    name: 'Dr. Jagdish Pusa',
    specialty: 'Orthopedic Surgeon',
    clinic: 'UNO Clinic',
    location: 'Hyderabad',
    image: '/doctors/Dr jagdish pusa - orthopedic surgeon - UNO Clinic.jpg',
  ...
  },
  {
    ...
    name: 'Dr. Keerthana',
    specialty: 'Urologist',
    clinic: 'Susheela Hospitals',
    location: 'Hyderabad',
    image: '/doctors/Dr keerthana urologist - Susheela Hospitals.jpg',
  ...
  },
  {
    ...
    name: 'Dr. Kiran Reddy',
    specialty: 'Orthopedic Surgeon',
    clinic: 'Kindle Clinic',
    location: 'Hyderabad',
    image: '/doctors/dr kiran reddy - othopedic - Kindle clinic.jpg',
  ...
  {
    id: 9,
    name: 'Dr. Meer Misbahuddin',
    specialty: 'Pain & Regenerative Medicine Specialist',
    clinic: 'Regen Cure Hospital',
    location: 'Hyderabad',
    image: '/doctors/Dr Meer Misbahuddin - Interventional Pain and Regenerative Medicine Specialist - Regen Cure Hospital.jpg',
    testimonial: 'Secure payment gateway integration for teleconsultation transactions is seamless. Patients can complete transactions online and we get instant notifications.',
    rating: 5,
  },
  {
    id: 10,
    ...
    clinic: 'JJ Hospital',
    location: 'Hyderabad',
    image: '/doctors/Dr Nikhila reddy - Gynecologist - jj hospital gynecologist.jpg',
  ...
  },
  {
    id: 12,
    name: 'Dr. Sameera',
    specialty: 'General, Laser & Laparoscopic Surgeon',
    clinic: 'Susheela Hospital',
    location: 'Hyderabad',
    image: '/doctors/DR sameera - General, Laser & Laparoscopic Surgeon - Susheela Hospital.jpg',
  ...
  {
    id: 13,
    name: 'Dr. Shashi Vardhan',
    specialty: 'Orthopedic',
    clinic: 'S&S Clinic',
    location: 'Hyderabad',
    image: '/doctors/Dr Shashi Vardhan - Orthopedic - S&S Clinic.jpg',
  ...
  {
    id: 18,
    name: 'Dr. Dheemanth Reddy',
    specialty: 'Neurologist',
    clinic: 'Neumed Clinics',
    location: 'Hyderabad',
    image: '/doctors/Dr. Dheemanth Reddy -Neurologist - Neumed clinics.jpg',
    testimonial: 'The analytics dashboard gives me insights into my practice that I never had before. Highly recommended for any specialist clinic!',
    rating: 5,
  },
  {
    id: 19,
    name: 'Dr. Pallavi Reddy Mekala',
    specialty: 'Obstetrician & Gynecologist',
    clinic: 'ONEDORS Clinic',
    location: 'Hyderabad',
    image: '/doctors/Dr. Pallavi Reddy Mekala  Obstetrician & Gynecologist - ONEDORS Clinic.jpg',
    testimonial: 'From booking to follow-up, TDAppointments handles everything. Our no-show rate dropped by 60% after implementing their system.',
    rating: 5,
  },
  {
    id: 20,
    name: 'Dr. Pampana Priyadarshini',
    specialty: 'Gynecologist',
    clinic: 'Avila Clinic',
    location: 'Hyderabad',
    image: '/doctors/Dr. Pampana Priyadarshini - Gynecologist - Avila clinic.jpg',
    testimonial: 'The automated review reminders have helped us get over 100 Google reviews. Our online presence has improved significantly!',
    rating: 5,
  },
  {
    id: 21,
    name: 'Dr. G. Stitha Pragna',
    specialty: 'Hemato-Oncologist',
    clinic: 'Continental Hospital',
    location: 'Hyderabad',
    image: '/doctors/Dr.G. Stitha Pragna - Hemato-Oncologist Bone Marrow Transplant Physician - Continental Hospital.jpg',
    testimonial: 'Managing multiple doctors and their schedules was challenging. TDAppointments made it effortless with their intuitive dashboard.',
    rating: 5,
  },
  {
          ...
          <div className="overflow-hidden px-4">
            ...
            >
              {getVisibleDoctors().map((doctor, idx) => (
                ...
                >
                  {/* Doctor Image - SEO optimised with Next.js Image */}
